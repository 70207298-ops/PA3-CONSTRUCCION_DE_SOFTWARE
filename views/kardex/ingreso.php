<div class="container" style="max-width: 820px;">
  <h4 class="mb-3">Ingreso de Stock</h4>
  <form method="post" action="index.php?c=kardex&a=guardarIngreso">
    <?= csrf_field() ?>
    <div class="card">
      <div class="card-body">
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <input type="number" step="0.0001" name="costo_unit" class="form-control" value="0">
          </div>
          <div class="col-md-4">
